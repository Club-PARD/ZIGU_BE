...
public class BorrowedController {
    ...
    @GetMapping("/borrow")
    public ResponseEntity<ApiResponse<List<BorrInfoResDto>>> getBorrowedList(Long userId){
    ...
    @GetMapping("/lend")
    public ResponseEntity<ApiResponse<List<BorrInfoResDto>>> getLendList(Long userId){
    ...
    @PatchMapping("/return")
    public ResponseEntity<ApiResponse<Void>> returnCompleted(Long borrowedId){
